namespace WebApplication4.Migrations
{
    ...
    public partial class mymig : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        id = c.Long(nullable: false, identity: true),
                        SeatingNumber = c.Long(nullable: false),
                        Name = c.String(),
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.subjectID, t.EvaluationID, t.StudentID })
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.EvaluationId, t.SubjectId })
                .ForeignKey("dbo.Evaluations", t => t.EvaluationId, cascadeDelete: true)
                .ForeignKey("dbo.Subjects", t => t.SubjectId, cascadeDelete: true)
                .Index(t => t.EvaluationId)
                .Index(t => t.SubjectId);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.ControlId, t.SubjectId })
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.SubjectId, t.RateId })
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.YearID, t.StudentID, t.PatchID })
                .ForeignKey("dbo.Patches", t => t.PatchID, cascadeDelete: true)
                .ForeignKey("dbo.Students", t => t.StudentID, cascadeDelete: true)
                .ForeignKey("dbo.Years", t => t.YearID, cascadeDelete: true)
                .Index(t => t.YearID)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.StudentYearPatches", "StudentID", "dbo.Students");
            DropForeignKey("dbo.StudentYearPatches", "PatchID", "dbo.Patches");
            DropForeignKey("dbo.StudentEnrollSubjects", "StudentId", "dbo.Students");
            DropForeignKey("dbo.Students", "SectionID", "dbo.sections");
            DropForeignKey("dbo.EvaluationSubjectStudents", "StudentID", "dbo.Students");
            DropForeignKey("dbo.SubjectRates", "SubjectId", "dbo.Subjects");
            DropForeignKey("dbo.SubjectRates", "RateId", "dbo.Rates");
            DropForeignKey("dbo.SubjectEvaluations", "SubjectId", "dbo.Subjects");
            DropForeignKey("dbo.StudentEnrollSubjects", "subjectID", "dbo.Subjects");
            DropForeignKey("dbo.Subjects", "PatchId", "dbo.Patches");
            DropForeignKey("dbo.EvaluationSubjectStudents", "subjectID", "dbo.Subjects");
            DropForeignKey("dbo.ControlSubjects", "SubjectId", "dbo.Subjects");
            DropForeignKey("dbo.Controls", "userID", "dbo.Users");
            ...
            DropIndex("dbo.StudentYearPatches", new[] { "StudentID" });
            DropIndex("dbo.StudentYearPatches", new[] { "YearID" });
            DropIndex("dbo.SubjectRates", new[] { "RateId" });
            DropIndex("dbo.SubjectRates", new[] { "SubjectId" });
            DropIndex("dbo.Controls", new[] { "userID" });
            DropIndex("dbo.ControlSubjects", new[] { "SubjectId" });
            DropIndex("dbo.ControlSubjects", new[] { "ControlId" });
            DropIndex("dbo.Subjects", new[] { "PatchId" });
            DropIndex("dbo.SubjectEvaluations", new[] { "SubjectId" });
            DropIndex("dbo.SubjectEvaluations", new[] { "EvaluationId" });
            DropIndex("dbo.EvaluationSubjectStudents", new[] { "StudentID" });
            DropIndex("dbo.EvaluationSubjectStudents", new[] { "EvaluationID" });
            DropIndex("dbo.EvaluationSubjectStudents", new[] { "subjectID" });
            ...
            DropIndex("dbo.StudentEnrollSubjects", new[] { "StudentId" });
            DropIndex("dbo.StudentEnrollSubjects", new[] { "subjectID" });
